...
|-----|--------------------------------------------------------------------------|-------------------------------------------------------------------------------|-------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 0   | Week 1    | Introduction to the Design Verification unit COMS30026       | live session <!--[View](Lectures/Current/0_Introduction_to_DVunit.pdf)-->                        | [The limits of Correctness](Supplementary/The_limits_of_Correctness.pdf) <br> from the [ACM Digital Library](https://dl.acm.org/citation.cfm?id=379512)                                                                                                        |
| 1   | Week 1    | Introduction to Design Verification                          | [View](Lectures/Current/1_Introduction_to_DV_ALL-SLIDES_plain.pdf)            | [ITRS Reports](http://www.itrs2.net/itrs-reports.html) <br> Read the paper by Harry Foster on [Why the Design Productivity Gap never happened](/Supplementary/Why-the-DV-Productivity-Gap-never-happened.pdf)                                                                                                        |
...
| 4   | Week (2)  | Hardware Design Languages (mainly self-study and live session) | [View](Lectures/Current/4_Hardware_Design_Languages.v.pdf)                    | BOOK: Verilog HDL by Samir Palnitkar \[in QB Library]                                                                                                                                                                                                                  |
...
| 8.3 | Week 4    | Coverage Part III: Coverage Analyse                          | [plain](Lectures/Current/6_Coverage-Part-III-narrated_v8-plain.pdf) <br> [with ink](Lectures/Current/6_Coverage-Part-III-narrated_v8-ink.pdf)                           |  |
...
| 13  | Week 11   | SoC Verification (Guest Lecture by Mike Benjamin, TVS)       | [View](Lectures/Current/13_SoCVerification_MB_TVS.v.pdf)                      | [Functional verification of IBM's POWER7 processor core](Supplementary/Mainline_Functional_Verification_of_IBMs_POWER7_Processor_Core.pdf) |
